...
public class LottoMachineTest {
    ...
    void checkTicketCountByPayMoney(int money, int expectedLottoTicketCount) {
        List<LottoTicket> lottoTickets = LottoMachine.createLottoTickets(Money.of(money));
    ...
    void manualLottoByCreation(int money, int expectedLottoTicketCount) {
        ...
        List<LottoTicket> tickets = LottoMachine.createLottoTickets(Money.of(money),
                LottoTicketForms.of(Arrays.asList(lottoTicketForm, lottoTicketForm2)));
